...
import { BehaviorSubject } from 'rxjs'; // for dynamic cart badge
...
export class CartService {
    ...
    //Observable for numberr of products in shopping car
    cartItemCount$!: BehaviorSubject<number>; // ! because initualised in constructor
    ...
    constructor() {
        ...
        this.cartItemCount$ = new BehaviorSubject<number>(this.getTotalCartItems());
    }
    ...
    addCartItem(item: CartItem): void {
        ...
        this.cartItemCount$.next(this.getTotalCartItems()); // updated
    }
    ...
    clearCart(): void {
        this.items = [];
        localStorage.removeItem('cartItems');
        this.cartItemCount$.next(0); // set back
    }
